public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Radius= "+c1.getRadius());//test condition in the constructor
        c1.setRadius(2);
        ...
        System.out.println("Height= "+r1.getHeight()+"\nWidth= "+r1.getWidth());//test condition in the constructor
        r1.setWidth(3);
        r1.setHeight(6);
        System.out.println("Height= "+r1.getHeight()+"\nWidth= "+r1.getWidth());
        ...
        System.out.println("Height= "+t1.getHeight()+"\nbase= "+ t1.getBase());//test condition in the constructor
        t1.setHeight(8.66);
        t1.setBase(10);
        System.out.println("Height= "+t1.getHeight()+"\nbase= "+ t1.getBase());
        System.out.printf("Area= %.2f \nPerimeter= %.2f"+"\n",r1.calculateArea(),r1.calculateCircumference());
